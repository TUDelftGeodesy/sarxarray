...
Bperp          [m]:      -15.9          // Perpendicular baseline
Bpar           [m]:      -18.9          // Parallel baseline
Bh             [m]:      -24.2          // Horizontal baseline
Bv             [m]:      5              // Vertical baseline
B              [m]:      24.8           // Baseline (distance between sensors)
alpha          [deg]:    168.3          // Baseline orientation
theta          [deg]:    38.3           // look angle
inc_angle      [deg]:    43.6           // incidence angle
orbitconv      [deg]:    0.00104531     // angle between orbits
Height_amb     [m]:      1115.1         // height = h_amb*phase/2pi (approximately)
Control point master (line,pixel,hei) =      (3441, 12433, 0)
Control point slave  (line,pixel,hei) =      (3442.29, 12441.2, 0)
...
Coarse_orbits_translation_lines:             1
Coarse_orbits_translation_pixels:            8
******************************************************************* 
...
Number of pixels (multilooked):             24866
******************************************************************* 
